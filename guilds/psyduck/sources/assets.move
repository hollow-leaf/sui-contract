module psyduck::psyduck_assets {
    ...
    public struct PSYDUCK_HYPERCERT has drop {}
    ...
    fun init (otw: PSYDUCK_HYPERCERT, ctx: &mut TxContext){
    ...
    public fun init_for_testing(ctx: &mut TxContext) {
        init(PSYDUCK_HYPERCERT{}, ctx);
    }

    // define your owned assets in below
